...
export const getGetHeroesHeroesGetQueryKey = (
	params: GetHeroesHeroesGetParams,
) => {
	return [`/heroes`, ...(params ? [params] : [])] as const;
};

export const getGetHeroesHeroesGetInfiniteQueryOptions = <
	TData = InfiniteData<
		Awaited<ReturnType<typeof getHeroesHeroesGet>>,
		GetHeroesHeroesGetParams["offset"]
	>,
	TError = HTTPValidationError,
>(
	params: GetHeroesHeroesGetParams,
	...
	const queryKey =
		queryOptions?.queryKey ?? getGetHeroesHeroesGetQueryKey(params);
...
export type GetHeroesHeroesGetInfiniteQueryResult = NonNullable<
	Awaited<ReturnType<typeof getHeroesHeroesGet>>
>;
export type GetHeroesHeroesGetInfiniteQueryError = HTTPValidationError;

export function useGetHeroesHeroesGetInfinite<
	TData = InfiniteData<
		Awaited<ReturnType<typeof getHeroesHeroesGet>>,
		GetHeroesHeroesGetParams["offset"]
	>,
...
>(
	...
	const queryOptions = getGetHeroesHeroesGetInfiniteQueryOptions(
		params,
		options,
	);
...
export const getGetHeroesHeroesGetQueryOptions = <
	TData = Awaited<ReturnType<typeof getHeroesHeroesGet>>,
	TError = HTTPValidationError,
>(
	params: GetHeroesHeroesGetParams,
	options?: {
	...
	const queryFn: QueryFunction<
		Awaited<ReturnType<typeof getHeroesHeroesGet>>
	> = ({ signal }) => getHeroesHeroesGet(params, signal);
...
export type GetHeroesHeroesGetQueryResult = NonNullable<
	Awaited<ReturnType<typeof getHeroesHeroesGet>>
>;
export type GetHeroesHeroesGetQueryError = HTTPValidationError;

export function useGetHeroesHeroesGet<
	TData = Awaited<ReturnType<typeof getHeroesHeroesGet>>,
	TError = HTTPValidationError,
>(
	params: GetHeroesHeroesGetParams,
