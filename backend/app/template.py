...
選択されたラベルについて、より詳細な説明を3つ提案してください。
回答は後述のPydanticスキーマに従い、JSON形式で出力してください。
推測や創作は最小限に抑えてください。
出力は敬語を使わず、平易で直接的な表現にしてください。
...
【分析の視点】
- このラベルが失敗事例とどのように関連しているか
- なぜこのラベルが重要な要因として選ばれたのか
- このラベルが失敗にどのように影響を与えたのか

【回答形式】
- 各要素のtypeは必ず"belief"を指定してください
- descriptionは2-3文で具体的に説明してください
- 説明は以下の3つの異なる視点から記述してください：
  1. 事実に基づく具体的な説明
  2. 心理的・感情的な影響の説明
  3. 行動や結果への影響の説明
