...
from app.chain import ConsequenceChain
from app.model import ElementType


def test_consequence_chain():
    # .envファイルから環境変数を読み込む
    load_dotenv()
    ...
    # ConsequenceChainを初期化
    chain = ConsequenceChain(llm)
    ...
    for element in result.elements:
        # 各要素の検証
        assert element.type == ElementType.CONSEQUENCE  # typeがconsequenceであること
